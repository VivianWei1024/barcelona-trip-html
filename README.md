Barcelona Trip HTML：
An AI vibe-coded travel webpage that transforms a 3-day Barcelona itinerary into a polished, interactive, and shareable landing page.
...
Rename the final file to index.html
Upload it to the repository root
Enable GitHub Pages from main + /root

Why this project matters：
This is a small but practical example of AI vibe coding:
the user defined the taste, direction, and feedback; the AI turned that into code, then kept refining the experience through multiple rounds until it felt right.

Credits：
Travel plan, direction, and feedback: User
Implementation and iteration: AI-assisted vibe coding workflow
